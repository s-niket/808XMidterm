...
Controller::Controller(double gainP, double gainD, double gainI,
                       double steeringLimit, double wheelDiameter, double width,
                       double base) {
  kp = gainP;
  ki = gainI;
  kd = gainD;
 ...
 * @return error         The error between an initial value and final value of type double
 */
